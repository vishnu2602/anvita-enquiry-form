<div class="anvita-enq basic">
	<form method='post' role='form' name='quickcontact' id='quickcontact'>
		...
		<select name='enq-country' class="enq-country anv_select_country form-control enq-input select" id='enq-country' onChange='getSelectedCountry(this)'>
		...
		<input type="hidden" class="enq-captchavar" name="enq-var" value="<?php echo $enq_rand; ?>"/>
			...
			<div style="width:60%; float:left;"><img style="width:90px;" class="enq-captchaimg" src="<?php echo ANVITA_ENQUIRY_PLUGIN_URL.'captcha.php?var='.$enq_rand; ?>"/>
